...
```{r fig-prisma, echo=FALSE, out.width="70%", fig.cap="Flowchart of the literature survey."}
my_graphics("PRISMA")
```
...
```{r fig-ad8232, echo=FALSE, out.width="40%", fig.show="hold", fig.cap="Single Lead Heart Rate Monitor"}
...
```{r fig-rawsignal, echo=FALSE, out.width="50%", fig.cap="RAW output from Arduino at ~300hz"}
...
```{r fig-filtersignal, echo=FALSE, out.width="90%", fig.cap="Gray is RAW, Red is filtered"}
...
```{r fig-sqi, echo=FALSE, out.width="100%", fig.cap="Green line is the \"complexity\" of the signal"}
my_graphics("noise")
```
...
```{r fig-datafilter, echo=FALSE, out.width="100%", fig.cap="Noisy data marked by the \"complexity\" filter"}
...
```{r fig-arcsoriginal, echo=FALSE, out.width="100%", fig.cap="FLUSS algorithm, using arc counts."}
...
```{r fig-vtachy, echo=FALSE, out.width="90%", fig.cap="Shapelet candidates for Ventricular Tachycardia.", fig.height=9, fig.width=14}
...
```{r fig-esp32, echo=FALSE, out.width="50%", fig.cap="ESP32 MCU"}
my_graphics("esp32")
```
