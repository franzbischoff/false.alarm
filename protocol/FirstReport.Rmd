...
Last Updated: 2021-08-12 1:35:04 UTC
...
Patient Safety Goal. Nowadays (2021), the subject still on their list, in fourth place of importance
[@the_jc2021].
...
knitr::include_graphics(here("docs", "figure/roadmap_original.png"))
```

```{r zenhub2, echo=FALSE, out.width="100%", fig.cap="Roadmap updated"}
knitr::include_graphics(here("docs", "figure/roadmap_updated.png"))
```
...
knitr::include_graphics(here("docs", "figure/sparkfun.jpg"))
```

```{r fullsetup, echo=FALSE, out.width="50%", fig.cap="Single Lead Heart Rate Monitor"}
knitr::include_graphics(here("docs", "figure/FullSetup.jpg"))
```
...
knitr::include_graphics(here("docs", "figure/regime_filtered.png"))
```
...
knitr::include_graphics(here("docs", "figure/regime_false.png"))
```
...
knitr::include_graphics(here("docs", "figure/regime_true.png"))
```
