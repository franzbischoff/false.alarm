...
Last Updated: 2021-07-15 02:11:01 UTC
...
They used as score the formula on Equation \@ref(eq:score):

\begin{equation}
Score = \frac{TP+TN}{TP+TN+FP+5*FN}   (\#eq:score)
\end{equation}

The five-best scores (for real-time) in this challenge are described on Table \@ref(tab:challenge):
...
```{r timeline, echo=FALSE, out.width="100%", fig.link="https://app.zenhub.com/workspaces/phd-thesis-5eb2ce34f5f30b3aed0a35af/roadmap"}
#| fig.cap="Click on the image to open an interactive Gantt webpage."
knitr::include_graphics(here("docs", "figure/timeline.png"))
```
