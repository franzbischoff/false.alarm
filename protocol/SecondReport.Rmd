...
[here](https://github.com/franzbischoff/false.alarm/commit/a9a9bc481ea90508450965596b811cb1a499a814#diff-f34a6bd3da5c4faa6a8103611963f84ee3070b59f1f517ea418e9774b4d718da).
...
restructuration. The new roadmap was already shown above on Fig. \@ref(fig:zenhub3).
...
2. **On the Matrix Profile:** since the first paper presenting this new concept [@Yeh2017a], lots of
   ...
   1. The main issue on the algorithms above is the dependency on a fast Fourier transform (FFT)
      ...
      matrices in less time using no FFT in an ESP32 MCU (Fig. \@ref(fig:esp32)).
