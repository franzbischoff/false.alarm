...
By August 2021, it was clear that the chosen regime detection algorithm will be the FLOSS
[@gharghabi2017]. Thus, the pipeline had to be adapted in order to allow the careful replication of
the streaming process, even though several computations are made beforehand to keep the pipeline
(i.e.: the simulation) fast on exploring several parameters.
