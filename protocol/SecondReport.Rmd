...
if (knitr::is_latex_output()) {
  knitr::include_graphics(here("docs", "figure/targets.pdf"))
} else {
  knitr::include_graphics(here("docs", "figure/targets.svg"))
}
```
...
knitr::include_graphics(here("docs", "figure/workflowr_print.png"))
```
...
knitr::include_graphics(here("docs", "figure/mp_1.png"))
```
...
knitr::include_graphics(here("docs", "figure/PRISMA.png"))
```
...
knitr::include_graphics(here("docs", "figure/arduino_plot.jpg"))
```
...
knitr::include_graphics(here("docs", "figure/filtered_ecg.png"))
```
...
knitr::include_graphics(here("docs", "figure/noise.png"))
```
...
if (knitr::is_latex_output()) {
  knitr::include_graphics(here("docs", "figure/regime_filter.pdf"))
} else {
  knitr::include_graphics(here("docs", "figure/regime_filter.svg"))
}
```
...
if (knitr::is_latex_output()) {
  knitr::include_graphics(here("docs", "figure/fluss_arcs.pdf"))
} else {
  knitr::include_graphics(here("docs", "figure/fluss_arcs.svg"))
}
```
...
if (knitr::is_latex_output()) {
  knitr::include_graphics(here("docs", "figure/contrast.pdf"))
} else {
  knitr::include_graphics(here("docs", "figure/contrast.svg"))
}
```
...
if (knitr::is_latex_output()) {
  knitr::include_graphics(here("docs", "figure/draw-nested-resampling.pdf"))
} else {
  knitr::include_graphics(here("docs", "figure/draw-nested-resampling.svg"))
}
```
\
...
if (knitr::is_latex_output()) {
  knitr::include_graphics(here("docs", "figure/draw-regime-model.pdf"))
} else {
  knitr::include_graphics(here("docs", "figure/draw-regime-model.svg"))
}
```
...
if (knitr::is_latex_output()) {
  knitr::include_graphics(here("docs", "figure/draw-classif-model.pdf"))
} else {
  knitr::include_graphics(here("docs", "figure/draw-classif-model.svg"))
}
```
...
if (knitr::is_latex_output()) {
  knitr::include_graphics(here("docs", "figure/draw-global-model.pdf"))
} else {
  knitr::include_graphics(here("docs", "figure/draw-global-model.svg"))
}
```
...
if (knitr::is_latex_output()) {
  knitr::include_graphics(here("docs", "figure/floss_eval.pdf"))
} else {
  knitr::include_graphics(here("docs", "figure/floss_eval.svg"))
}
```
...
knitr::include_graphics(here("docs", "figure/floss_regime.png"))
```
...
knitr::include_graphics(here("docs", "figure/esp32.jpg"))
```
