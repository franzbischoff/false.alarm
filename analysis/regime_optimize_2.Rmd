...
```{r cached, echo=FALSE, cache=TRUE}
...
```{r marginalplot, eval = FALSE, out.width="100%", cache=TRUE}
...
```{r performanceplot, eval=FALSE, fig.height = 7.5, out.width="90%", cache=TRUE}
...
```{r holdout, eval = FALSE, cache=TRUE}
...
```{r modelbart, message=FALSE, cache=TRUE}
...
```{r interaction, fig.height = 5, fig.width= 8, out.width="100%", cache=TRUE}
...
```{r importance, fig.height = 7, fig.width= 15, out.width="100%", cache=TRUE}
...
```{r importanceshap, message=FALSE, fig.height = 6, fig.width= 10, out.width="100%", cache=TRUE}
...
```{r importanceshap2, message=FALSE, fig.height = 6, fig.width= 10, out.width="100%", cache=TRUE}
...
```{r preliminar,fig.height=10, fig.width=15, out.width="100%", results="asis", cache=TRUE}
...
```{r global, eval=TRUE, fig.height=5, fig.width=10, out.width="100%", cache=TRUE}
...
```{r worst, eval=TRUE, fig.height=15, fig.width=12, out.width="100%", dev="png", cache=TRUE}
...
```{r best, eval=TRUE, fig.height=15, fig.width=12, out.width="100%", dev="png", cache=TRUE}
...
```{r globalmodel, eval=TRUE, fig.height=5, fig.width=10, out.width="100%", cache=TRUE}
...
```{r bestmodels, eval=TRUE, fig.height=22, fig.width=18, out.width="100%", cache=TRUE}
