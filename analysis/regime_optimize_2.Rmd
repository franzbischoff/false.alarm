...
all_scores <- readRDS(here::here("dev/all_scores3.rds"))
...
if (file.exists(here("output", "importances_lmk.rds"))) {
  ...
  pbFinished("importance_shap done")
  ...
  pbFinished("shap_fastshap_all_test done")
...
predictor_names_int <- c(predictors_names, "int_rt_rl", "int_mp_w")
...
if (file.exists(here("output", "dbarts_fitted2_lmk.rds"))) {
  ...
  pbFinished("trained_model2 done")
...
if (file.exists(here("output", "importances2_lmk.rds"))) {
  ...
  pbFinished("shap_fastshap_all_test2 done")
