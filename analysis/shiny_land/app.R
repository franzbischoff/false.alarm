...
ui <- fluidPage(
  ...
  sidebarLayout(
    ...
    sidebarPanel(
      ...
      sliderInput(
        inputId = "window_size", label = "window_size:", min = 25, max = 150, value = 50, step = 25
      ),
      sliderInput(
        inputId = "regime_landmark", label = "regime_landmark:", min = 1, max = 10, value = 9, step = 0.5
      ),
      sliderInput(
        inputId = "regime_threshold", label = "regime_threshold:", min = 0.05, max = 0.9, value = 0.55, step = 0.05
      ),
      sliderInput(
        inputId = "time_constraint", label = "time_constraint:", min = 0, max = 2000, value = 0, step = 50
      ),
      sliderInput(
