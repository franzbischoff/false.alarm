...
```{r importanceshap_old, eval = FALSE, message=FALSE, fig.height = 6, fig.width= 10, out.width="100%", cache=FALSE}
...
ttdata <- testing_data[, predictors_names]
base_data <- testing_data[, outcome_name]$mean

d1 <- shapviz::shapviz(shap_fastshap_all_test, X = ttdata[, predictors_names], baseline = mean(base_data))
a1 <- shapviz::sv_dependence(d1, "mp_threshold", color_var = "auto") +
  ggplot2::geom_smooth(method = loess, colour = "#0000ff44", alpha = 0.2) +
  ggplot2::labs(y = ggplot2::element_blank()) +
  ggplot2::theme_bw()
a2 <- shapviz::sv_dependence(d1, "window_size", color_var = "auto") +
  ggplot2::geom_smooth(method = loess, colour = "#0000ff44", alpha = 0.2) +
  ggplot2::labs(y = ggplot2::element_blank()) +
  ggplot2::theme_bw()
a3 <- shapviz::sv_dependence(d1, "time_constraint", color_var = "auto") +
  ggplot2::geom_smooth(method = loess, colour = "#0000ff44", alpha = 0.2) +
  ggplot2::labs(y = ggplot2::element_blank()) +
  ggplot2::theme_bw()
a4 <- shapviz::sv_dependence(d1, "regime_threshold", color_var = "auto") +
  ggplot2::geom_smooth(method = loess, colour = "#0000ff44", alpha = 0.2) +
  ggplot2::labs(y = ggplot2::element_blank()) +
  ggplot2::theme_bw()
set.seed(2023)
all1 <- (a1 + a2) / (a3 + a4 + plot_layout(guides = "collect")) +
  plot_annotation(title = "Shapley value vs. variable values", subtitle = "Original fit", theme = ggplot2::theme_bw())
all1
```

```{r importanceshap2_old, eval=FALSE, message=FALSE, fig.height = 6, fig.width= 10, out.width="100%", cache=FALSE}
...
ttdata <- testing_data2[, predictors_names]
base_data <- testing_data2[, outcome_name]$mean

d1 <- shapviz::shapviz(shap_fastshap_all_test2, X = ttdata[, predictors_names], baseline = mean(base_data))
a1 <- shapviz::sv_dependence(d1, "mp_threshold", color_var = "auto") +
  ggplot2::geom_smooth(colour = "#0000ff44", alpha = 0.2) +
  ggplot2::labs(method = loess, y = ggplot2::element_blank()) +
  ggplot2::theme_bw()
a2 <- shapviz::sv_dependence(d1, "window_size", color_var = "auto") +
  ggplot2::geom_smooth(colour = "#0000ff44", alpha = 0.2) +
  ggplot2::labs(method = loess, y = ggplot2::element_blank()) +
...
a4 <- shapviz::sv_dependence(d1, "regime_threshold", color_var = "auto") +
  ...
  ggplot2::theme_bw()
set.seed(2023)
all2 <- (a1 + a2) / (a3 + a4 + plot_layout(guides = "collect")) +
  plot_annotation(title = "Shapley value vs. variable values", subtitle = "Re-fit for iteractions", theme = ggplot2::theme_bw())
all2
```
