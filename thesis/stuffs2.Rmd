...
include_graphics(here("protocol", "figure/subdivision.pdf"))
```
...
If you'd like to see examples of other things in this template, please contact the Data @ R\eed\ tm (email <da\ta
