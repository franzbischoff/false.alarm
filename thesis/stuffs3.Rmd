...
```{r targets, echo=FALSE, eval = FALSE, out.width="100%", fig.cap="Reproducible research workflow using `targets`."}
knitr::include_graphics(here("protocol", "figure/targets.png"))
```
...
```{r workflow_workflowr, echo=FALSE, eval = FALSE, out.width="100%", fig.cap="Reproducible reports using `workflowr.`"}
knitr::include_graphics(here("protocol", "figure/workflowr.png"))
```
