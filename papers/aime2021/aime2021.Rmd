...
- num: 3
  dept: Matrix Profile Foundation, Minnesota, USA
keywords:
- anomaly detection
- ECG
- fading factors
...
# knitr::kable(challenge, caption = "Challenge Results", format = "latex")
```
...
# knitr::kable(miles, caption = "Milestones", format = "latex")
```
...
# knitr::kable(budgets, caption = "Expected expenses", format = "latex")
```
