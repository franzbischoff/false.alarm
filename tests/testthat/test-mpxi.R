...
test_that("Normal mpx + update batch right with external stats", {
  ...
  test <- mpx_rcpp(data[data_vector], params$window_size, params$ez, 1.0, TRUE, FALSE, params$progress)
...
test_that("Normal mpx + update batch right with external stats2", {
  ...
  test <- mpx_rcpp(data[test_vector], params$window_size, params$ez, 1.0, TRUE, FALSE, params$progress)
...
test_that("Normal mpx + update batch right", {
  ...
  expect_identical(as.numeric(tester01$right_profile_index), as.numeric(tester001$right_profile_index))
  expect_identical(as.numeric(tester02$right_profile_index), as.numeric(tester002$right_profile_index))
  expect_identical(as.numeric(tester0100$right_profile_index), as.numeric(tester00100$right_profile_index))
